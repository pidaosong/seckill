...
public class OrderServiceImpl implements OrderServer {
    ...
    public MiaoshaOrder getMiaoshaOrderByUserIdProductId(Long userId, long productId) {
        return orderDao.getMiaoshaOrderByUserIdProductId(userId,productId);
    }
    ...
    public OrderInfo addOrder(User user, ProductVo product) {
        ...
        long effectNum = orderDao.insertOrderInfo(orderInfo);

        MiaoshaOrder miaoshaOrder = new MiaoshaOrder();
        miaoshaOrder.setOrderInfoId(effectNum);
